...
open class FlowNavigator<R : FlowRouter>(
    ...
    containerId: Int,
    protected val childFragmentManager: FragmentManager,
    ...
    override fun back() {
        if (!isActivity() && fragmentManager.backStackEntryCount != 0) {
    ...
    protected open fun isActivity() = fragmentManager == childFragmentManager
}